export default {
    ...
    courses: {
      ...
      specialOfferOptional: "Special offer (optional)",
      specialOfferPlaceholder: "Original price",
      specialOfferHint: "Set a higher original price to show a crossed-out price and Special offer badge on the courses page.",
    ...
    certificateTemplates: {
      ...
      createWithBuilder: "Create with Builder",
    ...
    certificateBuilder: {
      ...
      description: "Configure a certificate for all courses or a specific course, then review and save.",
      scope: "Scope",
      scopeAll: "All courses",
      scopeCourse: "Specific course",
      course: "Course",
      startFrom: "Start from existing template",
      startFromHint: "Optional — copy settings from a template",
      templateName: "Template name",
      orientation: "Orientation",
      landscape: "Landscape",
      portrait: "Portrait",
      backgroundImage: "Background image",
      backgroundHint: "Drag and drop a JPG or PNG (max 5MB), or choose a file.",
      backgroundUploaded: "Background image uploaded.",
      uploadingBackground: "Uploading background…",
      removeBackground: "Remove background",
      invalidImageType: "Only JPG and PNG images are allowed.",
      presetBackground: "Preset artwork",
      presetHint: "Used when no custom background image is set. Custom upload takes precedence.",
      bodyText: "Certificate text",
      livePreview: "Live preview",
      sampleNote: "Sample data — not a real certificate.",
      previewEmpty: "Enter certificate text to see a preview.",
      continueReview: "Continue to Review",
      reviewTitle: "Review certificate",
      reviewHint: "Check the near print-scale preview before saving.",
      reviewCheckAlignment: "Alignment looks correct for the chosen orientation",
      reviewCheckReadability: "Text is readable over the background",
      reviewCheckImage: "Background image quality is acceptable",
      back: "Back",
      save: "Save certificate",
      saved: "Certificate configuration saved.",
      discardConfirm: "Discard unsaved changes?",
      validationError: "Name, certificate text, and course (when scoped) are required.",
      openFromCourse: "Certificate Builder"
    },
    ...
    stripeSettings: {
      ...
      step1: "In Stripe Dashboard → Developers → API keys, create a Secret key (sk_…) or Restricted key (rk_…). Do not use a publishable pk_ key.",
      step2: "Paste the key below, then click Test Connection.",
      step3: "Create a webhook in Stripe pointing to the URL below, event: checkout.session.completed.",
      step4: "Paste the webhook signing secret (whsec_…) below and Save Settings.",
      webhookUrl: "Webhook endpoint URL",
      webhookUrlHint: "In Stripe → Developers → Webhooks, add this endpoint and select checkout.session.completed.",
      copyWebhookUrl: "Copy URL",
      webhookUrlCopied: "Webhook URL copied.",
      webhookUrlCopyFailed: "Could not copy URL. Copy it manually.",
      credentials: "Stripe credentials",
      hint: "Paste your Stripe secret or restricted key here. Values saved in admin override environment variables.",
      apiKey: "Secret / Restricted API Key",
      apiKeyPlaceholder: "sk_live_…, sk_test_…, rk_live_…, or rk_test_…",
      apiKeyHint: "Use sk_… or rk_… only (not pk_…). Leave unchanged to keep the existing key. Get keys from dashboard.stripe.com/apikeys.",
      webhookSecret: "Webhook signing secret",
      webhookSecretPlaceholder: "whsec_…",
      webhookSecretHint: "Required in production. Point Stripe webhooks at the URL above for checkout.session.completed.",
    ...
    payment: {
      ...
      signInToContinue: "Sign in on this page to continue to payment.",
      signInTitle: "Sign in to continue",
      signInDescription: "Log in to complete checkout for this course.",
