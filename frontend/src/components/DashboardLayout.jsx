...
import {
  Award, BarChart3, BookOpen, CreditCard, GraduationCap, Home, Key, LogOut, Mail, Menu, Users, Wallet
} from "lucide-react";
...
export const DashboardLayout = ({ children }) => {
  ...
  const navItems = user?.role === "admin" ? [
    ...
    { icon: Wallet, label: t("nav.stripeSettings"), path: "/admin/stripe-settings" },
